...
export default async function RSVPTokenPage({ params }: PageProps) {
  ...
  const finalConfig = dbConfig || {
    ...
    storyText: "Nos conhecemos na faculdade in 2018. O que começou com uma amizade sincera nas aulas de engenharia logo se transformou em algo maior. Sete anos depois, estamos prontos para dar o passo mais importante das nossas vidas!",
